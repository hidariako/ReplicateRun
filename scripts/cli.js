...
const contractABI = require("../artifacts/contracts/Replicaterun.sol/Replicaterun.json").abi;

program
    .name("replicaterun-cli")
    .description("CLI tool for Replicaterun smart contract")
    .version("1.0.0");
